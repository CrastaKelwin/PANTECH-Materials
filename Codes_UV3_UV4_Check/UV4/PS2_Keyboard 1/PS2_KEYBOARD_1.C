...
#define PS2_DATA			((IO1PIN & 0x00020000)>>17)
#define PS2_CLK				((IO1PIN & 0x00010000)>>16)
...
int main()
{
		IO1DIR	  &= ~0x00030000;				// P1.21 &P1.22 set as input direction
		IO1SET		|=  0x00030000;				// P1.21 &P1.22 set as input direction
